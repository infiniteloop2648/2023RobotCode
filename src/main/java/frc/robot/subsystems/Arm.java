...
public class Arm extends ProfiledPIDSubsystem {
    ...
    public Arm(){
        ...
        super(
            new ProfiledPIDController(
                ...
                new TrapezoidProfile.Constraints(
                    Constants.kArmMaxVelocitySecond, 
                    Constants.kArmMaxAccelRadPerSecond2)),
            Constants.kArmInitialPosition
        );

        this.getController().setTolerance(Units.degreesToRadians(2.5));

        armMotor = new CANSparkMax(Constants.kArm, MotorType.kBrushless);
         ...
         * this into account. 
         */
        armEncoder = new Encoder(Constants.kSourceChannelArmEncoder1, Constants.kSourceChannelArmEncoder2);
        armEncoder.setDistancePerPulse(Constants.kArmEncoderMultiplier);
        armEncoder.reset();
         ...
         * stops. 
         */
        setGoal(Constants.kArmInitialPosition);

        armSwitch = new DigitalInput(Constants.kSourceChannelArmSwitch);
    ...
    public void periodic(){
        ...
        currentMeasurement = measurementFilter.calculate(armEncoder.getDistance()+Constants.kArmInitialPosition);
