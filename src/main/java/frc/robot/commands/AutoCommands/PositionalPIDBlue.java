...
public class PositionalPIDBlue extends SequentialCommandGroup{

    public PositionalPIDBlue(Drivetrain drivetrain, Arm arm, Wrist wrist, Manipulator manipulator){
